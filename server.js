...
var PAGE_TOKEN = 'EAAZAmumFYeekBANlveqHFsBbl83empDgPLMHUEU8nu8DfEmfjZATol1t8CDKVncWGOpW4ngUZB7c6XLsTB56oLC8iTTIv32OBoYwLV3w7oGnFI04qoc4oPYcuhlEoPR7qVSHztDtZCIZBH5X5zXmgEQoe7g71M53mUvKbpQHZCaAZDZD';
...
function handleMessage(messageBody) {
  ...
  engine.runActions(
    ...
    function(newContext) {
      var newSession = Object.assign(session, {context: newContext});
...
function wrapActions(senderId) {
  return mapObject(
    actions,
    (f, k) => (request, ...rest) => {
      var withId = Object.assign(request, {fbid: senderId});
